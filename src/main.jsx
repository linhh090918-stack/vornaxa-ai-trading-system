...
function Logo(){return <div className="logo-wrap"><img src="/vornaxa-logo.png" className="site-logo" alt="Vornaxa Matrix Capital Logo"/><div><div className="logo-title">VMC</div><div className="logo-sub">VORNAXA MATRIX CAPITAL</div></div></div>}
